...
public class BubbleLaporanSelesaiController {
    ...
    void clickDetail(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Resource/Fxml/Administrator/DetailLaporanSelesai.fxml"));
            Parent root = loader.load();


            DetailLaporanSelesaiController controller = loader.getController();
            ...
            stage.setTitle("Detail Laporan Selesai");
